...
PSO2_ONLY_CONCEPTS = {
    ...
    "dark blast", "crafting", "mag evolution",
    "matter board", "extra class", "successor class",
    "unit set", "units list", "arm unit", "leg unit", "back unit",
    "photon chair",
}
    ...
    if game_version == "ngs":
        ...
        for concept in PSO2_ONLY_CONCEPTS:
            if concept in query_lower:
                return "pso2", None  # silent redirect, no user-facing warning needed
